...
// =========================================================
// CLIENT-FACING VERIFICATION STATUS MAPPING
// =========================================================
//
// The checks below surface many internal status codes, but
// the uploaded-file verification result shown to users is
// simplified into four outcomes:
//
//   AUTHENTIC     - File is authentic
//   TAMPERED      - File has been tampered with
//   UNKNOWN_FILE  - This file was not generated by ExpenseTracker
//   INVALID_FILE  - This file is invalid or unrecognized
//

const CLIENT_VERIFICATION_MESSAGES = {
  AUTHENTIC: "File is authentic",
  TAMPERED: "File has been tampered with",
  UNKNOWN_FILE:
    "This file was not generated by ExpenseTracker",
  INVALID_FILE:
    "This file is invalid or unrecognized",
};

const clientVerificationResult = (
  clientStatus
) => ({
  status: clientStatus,
  message:
    CLIENT_VERIFICATION_MESSAGES[
      clientStatus
    ],
});
    ...
    async (req, res) => {
      ...
      if (isPDF) {
        ...
        if (
          ...
          // A signature was found but failed cryptographic /
          // integrity checks -> the file was modified after
          // signing. No signature at all -> the file was
          // never signed by ExpenseTracker in the first place.
